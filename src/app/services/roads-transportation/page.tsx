...
// Filter transportation-related projects or get latest projects
const featuredProjects = allProjects
  .filter(project => 
    project.category.toLowerCase().includes('transportation') ||
    project.category.toLowerCase().includes('road') ||
    project.category.toLowerCase().includes('rail')
  )
  .slice(0, 3);

// If no transportation projects found, use latest projects
          ...
          <div className="relative">
            ...
            <div className="space-y-6">
              <p className="text-lg text-[#4a4a4a] leading-relaxed">
                Globtek's team of transportation engineers specializes in designing and planning comprehensive road networks, 
                rail infrastructure, and urban mobility solutions.
              </p>
              <p className="text-[#4a4a4a] leading-relaxed">
                With a strong foundation in transportation engineering and urban planning, the Globtek team is well-equipped 
                to tackle complex challenges and deliver innovative solutions that enhance connectivity and drive economic growth. 
                Their expertise in creating sustainable transportation networks tailored to specific regional needs sets 
                them apart as a leader in transportation services.
              </p>
            </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3 group hover:bg-white/[0.02] p-2.5 -mx-2.5 rounded-lg transition-all duration-300">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-400 text-sm leading-snug mt-1 group-hover:text-gray-300 transition-colors">Advanced highway and urban road engineering</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 group hover:bg-white/[0.02] p-2.5 -mx-2.5 rounded-lg transition-all duration-300">
                  <div className="w-8 h-8 rounded-lg bg-[#e43d30]/10 flex items-center justify-center flex-shrink-0 group-hover:bg-[#e43d30]/20 group-hover:scale-110 transition-all duration-300">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-400 text-sm leading-snug mt-1 group-hover:text-gray-300 transition-colors">Railway engineering and safety systems</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 group hover:bg-white/[0.02] p-2.5 -mx-2.5 rounded-lg transition-all duration-300">
                  <div className="w-8 h-8 rounded-lg bg-[#e43d30]/10 flex items-center justify-center flex-shrink-0 group-hover:bg-[#e43d30]/20 group-hover:scale-110 transition-all duration-300">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-[#4a4a4a] leading-relaxed">
              {featuredProjects.length > 0 
                ? "Discover how we've helped transform transportation infrastructure across various projects"
