    ...
    <main className="min-h-screen pt-32 pb-24">
      <Container>
        ...
        <div className="max-w-3xl mx-auto text-center animate-in">
          <h1 className="text-4xl md:text-5xl font-bold text-[#14171c] mb-6">
            Our Services
          </h1>
            ...
            >
              ...
              <div className="relative flex flex-col h-[180px]">
                <div className="flex-1 p-6">
                  <h3 className="text-xl font-semibold text-[#14171c] mb-2 group-hover:text-[#e43d30] transition-colors duration-300">
                    {service.title}
                  </h3>
