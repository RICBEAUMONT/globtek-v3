      ...
      <Container className="py-16 md:py-24">
        ...
        <section className="relative pt-36 pb-6 px-2 bg-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto items-start">
            {/* Service Step 1 */}
            <div className={`bg-[#14171c] rounded-xl shadow p-5 flex flex-col cursor-pointer transition-all duration-200 min-h-[126px] ${expanded === 1 ? '' : ''}`}
            ...
            {/* Service Step 2 */}
            <div className={`bg-[#14171c] rounded-xl shadow p-5 flex flex-col cursor-pointer transition-all duration-200 min-h-[126px] ${expanded === 2 ? '' : ''}`}
            ...
            {/* Service Step 3 */}
            <div className={`bg-[#14171c] rounded-xl shadow p-5 flex flex-col cursor-pointer transition-all duration-200 min-h-[126px] ${expanded === 3 ? '' : ''}`}
            ...
            {/* Service Step 4 */}
            <div className={`bg-[#14171c] rounded-xl shadow p-5 flex flex-col cursor-pointer transition-all duration-200 min-h-[126px] ${expanded === 4 ? '' : ''}`}
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
              ...
              <div className="group bg-white rounded-2xl shadow-lg p-8 border border-gray-100 hover:shadow-2xl transition-all duration-500 hover:-translate-y-1">
                <div className="flex items-center mb-6">
                  ...
                  <h3 className="text-xl font-bold text-[#14171c] group-hover:text-[#e43d30] transition-colors duration-300">Advanced Technology</h3>
                </div>
              ...
              <div className="group bg-white rounded-2xl shadow-lg p-8 border border-gray-100 hover:shadow-2xl transition-all duration-500 hover:-translate-y-1">
                <div className="flex items-center mb-6">
                  ...
                  <h3 className="text-xl font-bold text-[#14171c] group-hover:text-[#e43d30] transition-colors duration-300">Regional Expertise</h3>
                </div>
                <p className="text-gray-600 mb-6 leading-relaxed">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-10 border border-gray-100 relative overflow-hidden">
              ...
              <div className="flex items-center mb-8">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-[#14171c] mb-2">Compliance & Integration</h3>
