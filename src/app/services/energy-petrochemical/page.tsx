...
// Filter energy-related projects and sort by completion date
const featuredProjects = allProjects
  .filter(project => 
    project.category.toLowerCase().includes('energy') ||
    project.category.toLowerCase().includes('petrochemical') ||
    project.category.toLowerCase().includes('renewable')
  )
  .sort((a, b) => {
...
// If no energy projects found, use latest projects sorted by date
...
const sectionTitle = featuredProjects.length > 0 
  ? "Our Energy & Petrochemical Success Stories"
  : "Our Featured Projects";

export default function EnergyPetrochemicalPage() {
  const { ref } = useScrollReveal();

  const timestamp = Date.now();
  const heroImages = [
    `/images/energy-petrochemical/hero.jpg`,
    `/images/energy-petrochemical/hero-2.jpg`,
    `/images/energy-petrochemical/hero-3.jpg`
  ];
  ...
  return (
    <main className="min-h-screen">
      <PageHero
        ...
        subtitle="Engineering & Management Solutions"
      ...
      <Container className="py-16 md:py-24" ref={ref}>
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-center">
          <div className="relative">
            ...
            <h2 className="text-[2.5rem] font-bold tracking-tight text-[#231f20] mb-6 leading-[1.1]">
              Advanced Energy & Petrochemical Solutions
            </h2>
            <div className="space-y-6">
              <p className="text-lg text-[#4a4a4a] leading-relaxed">
                Energy generation projects utilize various technologies, including oil, gas, wind, hydro, solar, and biomass. While there is a general migration from fossil fuels to renewable forms of energy, we recognize our clients' varied scenarios, demands, and aspirations and have developed the capability to meet the different project needs.
              </p>
              <p className="text-[#4a4a4a] leading-relaxed">
                Our services in this sector include engineering and design and the management of consultation processes for institutional, operational, regulatory, and contractual frameworks surrounding any energy or petrochemical project.
              </p>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 mt-8">
              <div className="flex flex-col items-center text-center p-4 rounded-xl hover:bg-gray-50 transition-colors duration-300">
                ...
                <span className="font-medium text-[#231f20]">Energy</span>
              </div>
              <div className="flex flex-col items-center text-center p-4 rounded-xl hover:bg-gray-50 transition-colors duration-300">
                <div className="w-12 h-12 rounded-xl bg-[#e43d30]/10 flex items-center justify-center mb-3">
                  <svg className="w-6 h-6 text-[#e43d30]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="font-medium text-[#231f20]">Engineering</span>
              </div>
              <div className="flex flex-col items-center text-center p-4 rounded-xl hover:bg-gray-50 transition-colors duration-300">
                <div className="w-12 h-12 rounded-xl bg-[#e43d30]/10 flex items-center justify-center mb-3">
                  <svg className="w-6 h-6 text-[#e43d30]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="font-medium text-[#231f20]">Management</span>
              </div>
            </div>
          </div>
          <div className="relative">
        ...
        <div className="mt-24">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-[#4a4a4a] leading-relaxed">
              Explore our portfolio of successful energy and petrochemical projects, showcasing our expertise in both traditional and renewable energy solutions.
            </p>
          </div>
      ...
      {/* Call to Action */}
      <SimpleCTA
        title="Ready to Start Your Energy Project?"
