...
// Filter marine-related projects or get latest projects
const featuredProjects = allProjects
  .filter(project => 
    project.category.toLowerCase().includes('marine') ||
    project.category.toLowerCase().includes('offshore') ||
    project.category.toLowerCase().includes('structural')
  )
  .slice(0, 3);

// If no marine projects found, use latest projects
...
const sectionTitle = featuredProjects.length > 0 
  ? "Our Marine Engineering Success Stories"
          ...
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-[#4a4a4a] leading-relaxed">
              {featuredProjects.length > 0
                ? "Discover how we've helped transform marine infrastructure across various projects"
