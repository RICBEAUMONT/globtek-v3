...
// Filter water-related projects and sort by completion date
const featuredProjects = allProjects
  .filter(project => 
    project.category.toLowerCase().includes('water') ||
    project.category.toLowerCase().includes('sanitation') ||
    project.category.toLowerCase().includes('irrigation')
  )
  .sort((a, b) => {
...
// If no water projects found, use latest projects sorted by date
...
const sectionTitle = featuredProjects.length > 0 
  ? "Our Water Sanitation Success Stories"
      ...
      <Container className="py-16 md:py-24" ref={ref}>
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-3 gap-4 mt-8">
              <div className="flex flex-col items-center text-center p-4 rounded-xl hover:bg-gray-50 transition-colors duration-300">
                ...
                <span className="font-medium text-[#231f20]">Infrastructure</span>
              </div>
              <div className="flex flex-col items-center text-center p-4 rounded-xl hover:bg-gray-50 transition-colors duration-300">
                <div className="w-12 h-12 rounded-xl bg-[#e43d30]/10 flex items-center justify-center mb-3">
                  <svg className="w-6 h-6 text-[#e43d30]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex flex-col items-center text-center p-4 rounded-xl hover:bg-gray-50 transition-colors duration-300">
                ...
                <span className="font-medium text-[#231f20]">Optimization</span>
              </div>
            </div>
          </div>
          <div className="relative">
        ...
        <div className="mt-24">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-[#4a4a4a] leading-relaxed">
              Explore our portfolio of successful water and sanitation projects, showcasing our expertise in infrastructure development, treatment systems, and water management solutions.
            </p>
          </div>
