...
export default function NavalDesignPage() {
  ...
  return (
    <main className="min-h-screen">
      <PageHero
        title="Naval Design Excellence"
        subtitle="Maritime Engineering Solutions"
        description="Pushing the boundaries of maritime design with innovative solutions for commercial, military, and recreational vessels."
        images={heroImages}
        slideInterval={6000}
        breadcrumbs={[
      ...
      <Container className="py-16 md:py-24">
          ...
          <div className="relative">
            ...
            <div className="space-y-6">
              <p className="text-lg text-[#4a4a4a] leading-relaxed">
                Globtek's team of naval architects specializes in conceptualizing and designing a wide range of vessels, 
                including commercial ships, military crafts, and recreational boats.
              </p>
              <p className="text-[#4a4a4a] leading-relaxed">
                With a strong naval architecture and marine engineering foundation, the Globtek team is well-equipped 
                to tackle complex challenges and deliver innovative solutions pushing maritime design's boundaries. 
                Their expertise in creating vessels tailored to the specific needs of various industry sectors sets 
                them apart as a leader in marine engineering services.
              </p>
            </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3 group hover:bg-white/[0.02] p-2.5 -mx-2.5 rounded-lg transition-all duration-300">
                  ...
                  <div className="flex-1">
                    <h4 className="text-white font-medium group-hover:text-[#e43d30] transition-colors">Naval Architecture</h4>
                    <p className="text-gray-400 text-sm leading-snug mt-1 group-hover:text-gray-300 transition-colors">Advanced vessel design and structural analysis</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 group hover:bg-white/[0.02] p-2.5 -mx-2.5 rounded-lg transition-all duration-300">
                  <div className="w-8 h-8 rounded-lg bg-[#e43d30]/10 flex items-center justify-center flex-shrink-0 group-hover:bg-[#e43d30]/20 group-hover:scale-110 transition-all duration-300">
                  ...
                  <div className="flex-1">
                    <h4 className="text-white font-medium group-hover:text-[#e43d30] transition-colors">Marine Engineering</h4>
                    <p className="text-gray-400 text-sm leading-snug mt-1 group-hover:text-gray-300 transition-colors">Propulsion systems and power optimization</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 group hover:bg-white/[0.02] p-2.5 -mx-2.5 rounded-lg transition-all duration-300">
                  <div className="w-8 h-8 rounded-lg bg-[#e43d30]/10 flex items-center justify-center flex-shrink-0 group-hover:bg-[#e43d30]/20 group-hover:scale-110 transition-all duration-300">
                  ...
                  <div className="flex-1">
                    <h4 className="text-white font-medium group-hover:text-[#e43d30] transition-colors">Hydrodynamics</h4>
                    <p className="text-gray-400 text-sm leading-snug mt-1 group-hover:text-gray-300 transition-colors">Advanced fluid dynamics and performance analysis</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 group hover:bg-white/[0.02] p-2.5 -mx-2.5 rounded-lg transition-all duration-300">
                  <div className="w-8 h-8 rounded-lg bg-[#e43d30]/10 flex items-center justify-center flex-shrink-0 group-hover:bg-[#e43d30]/20 group-hover:scale-110 transition-all duration-300">
                  ...
                  <div className="flex-1">
                    <h4 className="text-white font-medium group-hover:text-[#e43d30] transition-colors">Safety Systems</h4>
                    <p className="text-gray-400 text-sm leading-snug mt-1 group-hover:text-gray-300 transition-colors">Comprehensive safety and compliance solutions</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 group hover:bg-white/[0.02] p-2.5 -mx-2.5 rounded-lg transition-all duration-300">
                  <div className="w-8 h-8 rounded-lg bg-[#e43d30]/10 flex items-center justify-center flex-shrink-0 group-hover:bg-[#e43d30]/20 group-hover:scale-110 transition-all duration-300">
        ...
        <div className="mt-24">
          <SimpleCTA
            ...
            description="Let's discuss how our naval design expertise can bring your vision to life."
            primaryButton={{
              text: "Contact Us",
              href: "/contact"
            }}
