    ...
    return (
      <Container className="py-16 md:py-24">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-[#231f20] mb-4">Project Not Found</h1>
      ...
      <Container className="py-16 md:py-24">
        <div className="grid lg:grid-cols-3 gap-12">
          <div className="lg:col-span-2 space-y-12">
            <section>
              <h2 className="text-2xl font-bold text-[#231f20] mb-6">Project Overview</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-[#231f20] mb-6">The Challenge</h2>
              <p className="text-[#4a4a4a] leading-relaxed whitespace-pre-line">
            ...
            <section>
              <h2 className="text-2xl font-bold text-[#231f20] mb-6">Our Solution</h2>
              <p className="text-[#4a4a4a] leading-relaxed whitespace-pre-line">
            ...
            <section>
              <h2 className="text-2xl font-bold text-[#231f20] mb-6">Results</h2>
              <p className="text-[#4a4a4a] leading-relaxed whitespace-pre-line">
            ...
            {project.details.keyFeatures && (
              <section>
                <h2 className="text-2xl font-bold text-[#231f20] mb-6">Key Features</h2>
            ...
            {project.details.gallery && (
              <section>
                <h2 className="text-2xl font-bold text-[#231f20] mb-6">Project Gallery</h2>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-8 space-y-6">
              <div className="bg-white rounded-2xl shadow-lg p-6">
                <h3 className="text-xl font-bold text-[#231f20] mb-4">Project Details</h3>
                <div className="space-y-4">
                  <div>
                    <div className="text-sm text-[#4a4a4a]">Client</div>
                    <div className="font-medium text-[#231f20]">{project.client}</div>
                  </div>
                  <div>
                    <div className="text-sm text-[#4a4a4a]">Category</div>
                    <div className="font-medium text-[#231f20]">{project.category}</div>
                  </div>
                  <div>
                    <div className="text-sm text-[#4a4a4a]">Completion Date</div>
                    <div className="font-medium text-[#231f20]">{project.completionDate}</div>
                  </div>
                </div>
              </div>
              ...
              {project.details.specifications && (
                <div className="bg-white rounded-2xl shadow-lg p-6">
                  <h3 className="text-xl font-bold text-[#231f20] mb-4">Specifications</h3>
                  <div className="space-y-4">
                    {Object.entries(project.details.specifications).map(([key, value]) => (
                      <div key={key}>
                        <div className="text-sm text-[#4a4a4a]">{key}</div>
                        <div className="font-medium text-[#231f20]">{value}</div>
                      </div>
                    ))}
                  </div>
                </div>
