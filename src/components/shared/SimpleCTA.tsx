    ...
    <section className={`py-24 bg-white relative overflow-hidden ${className}`}>
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-[#14171c] mb-6 tracking-tight">
            {title}
            {titleAccent && (
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            ...
            <Link
              ...
              className="group w-full sm:w-auto inline-flex items-center justify-center px-8 py-4 text-[#14171c] font-medium hover:text-[#e43d30] transition-all duration-300 hover:bg-gray-50 rounded-lg"
            >
